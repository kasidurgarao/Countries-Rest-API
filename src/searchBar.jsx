...
//   setSortFilter,
//   }) {
//   console.log({ searchQuery, setSearchQuery, regionFilter, setRegionFilter });
//     return (
//       <>
...
//               <option vlaue="sorting" className="dark:bg-gray-800 dark:text-white">Sorting</option>
...
//                 All
//               </option>
//               <option value="africa" className="dark:bg-gray-800 dark:text-white">
//                 Africa
//               </option>
//               <option value="asia" className="dark:bg-gray-800 dark:text-white">
//                 Asia
//               </option>
//               <option value="america" className="dark:bg-gray-800 dark:text-white">
//                 America
//               </option>
//               <option value="oceania" className="dark:bg-gray-800 dark:text-white">
//                 Oceania
//               </option>
//               <option value="europe" className="dark:bg-gray-800 dark:text-white">
//                 Europe
//               </option>
//               <option value="antarctica" className="dark:bg-gray-800 dark:text-white">
//                 Antarctic
//               </option>
//             </select>
//             <div className="absolute inset-y-0 right-2 flex items-center px-3 pointer-events-none">
